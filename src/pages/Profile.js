...
import { getUserDetails } from '../store/user/api.user';
    ...
    <div>
      ...
      <div className="py-3 px-5 space-y-2 border-b-2">
        <div className=" flex items-center space-x-6 ">
          <h2 className="">View Profile</h2>
          <div className="rounded-full border-2 flex items-center justify-center h-8 w-8">
      ...
      <div className="">
        ...
        <div className="flex justify-between pb-2 px-5 border-b-2">
          <div className="flex items-center space-x-4">
            <h3>Gender:</h3>
            <p className="font-light">{capitalizeFirstLetter(user?.gender)}</p>
          </div>
          <div className="rounded-full border-2 flex items-center justify-center h-8 w-8">
            <PencilIcon className="h-5" />
          </div>
