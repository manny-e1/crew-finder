                ...
                <div className="bg-white py-8 px-6 shadow rounded-lg sm:px-10">
                    <form action="" className="mb-0 space-y-6">
                        <div>
                            <label
                                htmlFor="fullName"
                                className="block text sm font-medium text-gray-700">Full Name
                            </label>
                            <div className="mt-1">
                                <input
                        ...
                        <div>
                            <label
                                htmlFor="username"
                                className="block text sm font-medium text-gray-700">Username
                            </label>
                            <div className="mt-1">
                                <input
                                    type="text"
                        ...
                        <div>
                            <label
                                htmlFor="birthdate"
                                className="block text sm font-medium text-gray-700">Birth Date
                            </label>
                            <div className="mt-1">
                                <input
                                    type="date"
                            ...
                            {error?.birthdate && <p className="text-red-400">{error?.birthdate}</p>}
                        ...
                        <div class="flex flex-wrap -mx-3 mb-2">
                            ...
                            {error?.address && <p className="text-red-400">{error?.address}</p>}

                        </div>
                        <div>
                            <label
                                htmlFor="phoneNumber"
                                className="block text sm font-medium text-gray-700">Phone Number
                            </label>
                            <PhoneInput
                            ...
                            />
                            {error?.phoneNumber && <p className="text-red-400">{error?.phoneNumber}</p>}
                        </div>
                        ...
                        <div class="flex flex-wrap -mx-3 mb-2">
                            ...
                            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <div className="relative">
                                    <select onChange={e => setRole(e.target.value)} className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                            ...
                            <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <div className="relative">
                                    {
                                        role === rolechoice[0].toUpperCase() ?
                                            <select onChange={e => setTalent(e.target.value)} className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state">
                                ...
                                {error?.talent && <p className="text-red-400">{error?.talent}</p>}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <select onChange={e => setGender(e.target.value)} className='w-full border-gray-300 rounded-lg shadow-sm
                                focus:border-indigo-500 focus:ring-indigo-500'
                                id="phone">
                        ...
                        <div>
                            <button
                                ...
                                onClick={submitHandler}>{loading ? "..." : "Sign up"}</button>
                        </div>
