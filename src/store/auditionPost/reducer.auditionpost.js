...
export const auditionPostListReducer = (
  state = { auditionPosts: [] },
  action
) => {
  switch (action.type) {
...
export const auditionPostDeleteReducer = (state = {}, action) => {
  switch (action.type) {
    case AUDITIONPOST_DELETE_REQUEST:
      return { loading: true };
    case AUDITIONPOST_DELETE_SUCCESS:
      return { loading: false };
    case AUDITIONPOST_DELETE_FAIL:
      return { loading: false, error: action.payload };
    default:
      return state;
  }
