...
function UsersList({ user }: { user: IUser }) {
  return (
    <div className="mx-auto mt-5 max-w-5xl bg-white">
      <div className="flex space-x-2 px-3 py-2">
        <img
          ...
          alt=""
          className="h-24 w-28 rounded-lg md:h-28 md:w-32"
        />
        <div>
          <div className="flex items-center space-x-2">
            ...
            <div className="flex space-x-1">
              ...
              {user.verification === Verification.FAMOUS ? (
                <CheckBadgeIcon className="h-4 text-blue-500" />
              ) : user.verification === Verification.ENDORSED ? (
                <CheckBadgeIcon className="h-4 text-black" />
              ) : null}
            </div>
          </div>
          <div className="flex space-x-2">
            <p className="md:text-size-sm text-sm">Email: </p>
            <p className="md:text-size-sm text-sm">{user.email}</p>
          </div>
          <div className="flex space-x-2">
            <p className="md:text-size-sm text-sm">Role: </p>
            <p className="md:text-size-sm text-sm">{user.role}</p>
          </div>
          <div className="flex space-x-2">
            <p className="md:text-size-sm text-sm">Phone #: </p>
            <p className="md:text-size-sm text-sm">{user.phoneNumber}</p>
          </div>
          <div className="flex space-x-2">
