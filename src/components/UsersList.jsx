...
function UsersList({ user }) {
  return (
    <div className="max-w-5xl mx-auto mt-5 bg-white">
      <div className="flex space-x-2 px-3 py-2">
        <img
          ...
          alt=""
          className="rounded-lg h-24 w-28 md:h-28 md:w-32"
        />
        <div>
          <div className="flex space-x-2 items-center">
            ...
            <div className="flex space-x-1">
              ...
              {/* <BadgeCheckIcon className={user?.verification === "FAMOUS" ? "h-4 text-blue-500" : user?.verification === "ENDORSED" ? "h-4 text-black" : "hidden"}/> */}
            </div>
          </div>
          <div className="flex space-x-2">
            <p className="text-sm md:text-size-sm">Email: </p>
            <p className="text-sm md:text-size-sm">{user?.email}</p>
          </div>
          <div className="flex space-x-2">
            <p className="text-sm md:text-size-sm">Role: </p>
            <p className="text-sm md:text-size-sm">{user?.role}</p>
          </div>
          <div className="flex space-x-2">
            <p className="text-sm md:text-size-sm">Phone #: </p>
            <p className="text-sm md:text-size-sm">{user?.phoneNumber}</p>
          </div>
          <div className="flex space-x-2">
          ...
          <div className="flex space-x-2 items-center">
            <p className="text-sm md:text-size-sm">Other Talents: </p>
