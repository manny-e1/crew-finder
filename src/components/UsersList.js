  ...
  return (
    <div className="max-w-5xl mx-auto mt-5 bg-white">
      <div className="flex space-x-2 px-3 py-2">
        ...
        alt="" className="rounded-lg h-24 w-28 md:h-28 md:w-32"/>
          <div>
            <div className="flex space-x-2 items-center">
              <p className="text-sm md:text-size-sm">Name: </p>
              <div className="flex space-x-1">
                
            <p className="text-sm md:text-size-sm text-blue-400">{user?.fullName}</p>
...
<p className="text-sm md:text-size-sm">Talent: </p>
            <p className="text-sm md:text-size-sm">{capitalizeFirstLetter(user?.talent)}</p>
            </div>
            <div className="flex space-x-2 items-center">
