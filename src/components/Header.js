import { ClipboardListIcon, SearchIcon, UserIcon } from '@heroicons/react/solid';
...
function Header() {
  ...
  return (
    ...
    >
      ...
      {currentUser ? (
        <div
          className="md:flex md:flex-col hidden  items-center py-2 "
        >
          <input
          ...
          />
          {searchInput &&  <div className="w-1/4 rounded-md absolute top-12 bg-white mx-auto p-3 ">
                
                <div className="flex space-x-1 p-2 " onClick={e => userSeachHandler(e)}>
                    <UserIcon className="h-4"/>
                    <div>
                    <p className="font-light text-size-sm">
                        Talent
                    </p>
                   <p className="text-sm font-light">
                     lorem ipsum orem ipsum
                   </p>
                    </div>
            </div>
                <div className="flex space-x-1 p-2" onClick={e => auditionPostSeachHandler(e)}>
